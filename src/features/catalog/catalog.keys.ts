...
export const catalogKeys = {
  ...
  infiniteList: (filters: CatalogFilters) => [...catalogKeys.lists(), "infinite", filters] as const,
  searches: () => [...catalogKeys.all, "search"] as const,
  search: (query: string, page: number) => [...catalogKeys.searches(), query, page] as const,
  infiniteSearch: (query: string) => [...catalogKeys.searches(), "infinite", query] as const,
};
